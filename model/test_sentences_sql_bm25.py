...
from model_utils_sql_bm25 import opcount,plot_top_hist,create_submission,calculate_rank
...
if_train=True 
conti_run=False
TEST_INPUT = '../test_dataset_sql_bm25/' # Test data folder of SQL_BM25 search results dataset
BASE_DIR = '../input/'
OUT_DIR = '../output/'
MODEL_dir='../model/'
