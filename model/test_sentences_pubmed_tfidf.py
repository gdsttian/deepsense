...
from model_utils_pubmed_tfidf import opcount,plot_top_hist,create_submission,calculate_rank
...
if_train=True 
conti_run=False
TEST_INPUT = '../test_dataset_pubmed_tfidf/' # Test data folder of pubmed TFID search
BASE_DIR = '../input/'
OUT_DIR = '../output/'
MODEL_dir='../model/'
